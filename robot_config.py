...
#'Daniel', 'Luke', 'Joy','Aaron', 'Lincoln1'
...
if Robot_name == 'Daniel':
    ...
    DRIVE_BASE = DriveBase(DRIVE_LEFT, DRIVE_RIGHT, wheel_diameter=61.4, axle_track=140) # Calibrated for Daniel
